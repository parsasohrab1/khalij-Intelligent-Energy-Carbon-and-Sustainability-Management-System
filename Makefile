.PHONY: help install run test lint data up down logs producer consumer carbon-scheduler rto-scheduler ml-trainer up-prod up-monitoring up-demo up-ha demo demo-feeder plant-connect soak backup restore-dry-run e11-checklist
...
help:
	...
	@echo "  make rto-scheduler     - run E12 Real-Time Optimization advisory loop"
...
logs:
	docker compose logs -f api producer consumer carbon-scheduler rto-scheduler ml-trainer
